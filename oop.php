...
// $user1->name = 'Brad';
$user1 = new User('Brad', 'bradmark@gmail.com', '123456');
...
$employee1 = new employee('Jane', 'janedoe@gmail.com', '12345678', 'Director ICT');
echo $employee1->getName();
echo "<br>";
$employee2 = new employee('John', 'johndoe@gmail.com', '12345678', 'Manager');
